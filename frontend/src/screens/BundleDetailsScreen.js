...
const BundleDetailsScreen = ({ match, history }) => {
  ...
  const stockTexts = {
    inStock: { value: 'In Stock', nl: 'Op voorraad' },
    outStock: { value: 'Out Of Stock', nl: 'Geen voorraad' },
  };
      ...
      {loading ? (
        ...
        <>
          {bundle.name !== undefined && (
            <>
              <Meta title={renderWithLang(bundle.name, lang)} />
              <Row>
                <Col md={6}>
                  <Image src={bundle.image} alt={renderWithLang(bundle.name, lang)} fluid />
                </Col>
                <Col md={3}>
                  <ListGroup variant="flush">
                    <ListGroup.Item>
                      <h3>{renderWithLang(bundle.name, lang)}</h3>
                    </ListGroup.Item>
                    <ListGroup.Item>
                    ...
                    <ListGroup.Item>
                      ...
                      />
                      : {renderWithLang(bundle.description, lang)}
                    </ListGroup.Item>
                  </ListGroup>
                </Col>
                <Col md={3}>
                        ...
                        <Row>
                          ...
                          <Col>
                            {bundle.countInStock > 0
                              ? renderWithLang(stockTexts.inStock, lang)
                              : renderWithLang(stockTexts.outStock, lang)}
                          </Col>
                        </Row>
                      </ListGroup.Item>
